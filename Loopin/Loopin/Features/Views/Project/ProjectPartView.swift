...
//struct ProjectPartView_Previews: PreviewProvider {
//    static var previews: some View {
//        ProjectPartView(project: Project(type: "type", name: "name", image: "test", description: "description", preparation: "preparation", yarnType: "yarnType", yarnWeight: "yarnWeight", hookSize: "hookSize", stitchType: "stitchType", sample: Gauges(length: 0, width: 0, stitch: 0, row: 0)))
//    }
//}
